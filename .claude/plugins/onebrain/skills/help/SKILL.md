...
| `/recap` | Cross-session synthesis : reads 7 days of session logs + newly /learned memory/ files, surfaces patterns, updates MEMORY.md Key Learnings | Periodically, when you want to distill recent sessions into long-term memory |
