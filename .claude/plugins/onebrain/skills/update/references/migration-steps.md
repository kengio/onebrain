...
- Run `onebrain register-hooks` — registers Stop hook; removes stale onebrain entries from any non-allowed hook event; preserves user-added non-onebrain hooks under the same events
