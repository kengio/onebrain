...
Checkpoints: `07-logs/YYYY/MM/YYYY-MM-DD-{token}-checkpoint-NN.md` — auto-generated by hooks every 15 messages or 30 minutes, and before context compression. Incorporated and deleted by `/wrapup` when wrapping up.
...
Checkpoints: `YYYY-MM-DD-{token}-checkpoint-NN.md` — auto-generated mid-session by hooks. Incorporated and deleted by `/wrapup`.
