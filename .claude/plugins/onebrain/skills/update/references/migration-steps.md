...
- Run `onebrain register-hooks` — registers Stop, PostCompact, and UserPromptSubmit hooks; removes stale PreCompact hook if present; never removes user-added hooks in the same event key
